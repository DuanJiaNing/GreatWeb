...
import com.duan.dao.mapping.FieldToken;
import com.duan.dao.mapping.TableToken;
import com.duan.dao.mapping.Token;
import com.duan.util.Utils;

/**
 * 数据库 CRUD 操作实现类，T 类型参数对应为实体类，实体类要使用{@link com.duan.dao.mapping.Mapping}注解
